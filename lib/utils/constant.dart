...
class AppConstants {
  ...
  static const String baseUrlEcommerceDeliveryTimeslots =
      '$switchToBaseUrl/commerce-hp3ki/pub/v1/ninja/deliveryTimeSlots';
  ...
  static const String baseUrlDisbursement =
  ...
  static const String baseUrlEcommerce =
      '$switchToBaseUrl/commerce-hp3ki/api/v1';
  ...
  static const String baseUrlVa =
      'https://pg-$switchTo.connexist.id/payment_v2/pub/v1/payment/channels';
  static const String baseUrlVaV1 =
      'https://pg-$switchTo.connexist.id/payment/pub/v1/payment/channels';
  static const String baseUrlVaV2 =
  ...
  static const String baseUrlHelpPayment =
      'https://web.inovasi78.com/payment/howTo';
  ...
  static const String baseUrlEcommercePickupTimeslots =
      '$switchToBaseUrl/commerce-hp3ki/pub/v1/ninja/pickupTimeSlots';
  static const String baseUrlEcommerceDimensionSize =
      '$switchToBaseUrl/commerce-hp3ki/pub/v1/ninja/dimensionSizes';
  static const String baseUrlEcommerceApproximatelyVolumes =
      '$switchToBaseUrl/commerce-hp3ki/pub/v1/ninja/pickupApproxVolumes';
  ...
  static const String avatarDebug =
  ...
  static const String avatarError =
      'https://icon-library.com/images/avatar-icon-png/avatar-icon-png-26.jpg';
  static const String tokenDebug =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiIyZjRmNTA4OC05NjFlLTRiNjItOWQ2MC0wODc3ZWQxZDI3YTMiLCJhdXRob3JpemVkIjp0cnVlLCJpYXQiOjE2ODUyNjU5MjN9.22shJq5CFh4jTBBDL84AAWurqkGoLmeBnVJCylTuKIk';
