...
class CustomDropdown {
  ...
  static DropdownSearch<String> buildDropdownSearch({required List<String> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<JobData> buildDropdownSearchJob({required List<JobData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<BusinessData> buildDropdownSearchBusiness({required List<BusinessData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<ClassificationData> buildDropdownSearchClassification({required List<ClassificationData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<OrganizationData> buildDropdownSearchOrganization({required List<OrganizationData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<ProvinceData> buildDropdownSearchProvince(BuildContext context, {required List<ProvinceData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<DistrictData> buildDropdownSearchDistrict(BuildContext context, {required List<DistrictData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<CityData> buildDropdownSearchCity(BuildContext context, {required List<CityData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
  ...
  static DropdownSearch<SubdistrictData> buildDropdownSearchSubdistrict(BuildContext context, {required List<SubdistrictData> options, required String label, required String searchHint, required TextEditingController dropdownC}) {
    return DropdownSearch<SubdistrictData>(
      ...
      onChanged: (value) {
        context.read<RegionDropdownProvider>().setCurrentSubdistrict(name: value?.name ?? "...");
        dropdownC.text = value?.id ?? "-";
      },
    );
  }  
...
class RegionDropdown {
  ...
  static Column buildDropdownSection( BuildContext context,{
