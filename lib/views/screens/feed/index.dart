    ...
    return TabBarView(
        ...
        children: [
          Consumer<FeedProviderV2>(
            builder: (BuildContext context, FeedProviderV2 feedProvider,
                Widget? child) {
                        ...
                        return InkWell(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (forum.type == "image")
                                  PostImage(forum.user!.username!,
                                      forum.caption!, false, forum.media!),
                                if (forum.type == "video")
                                  VisibilityDetector(
                                        ...
                                        child: Column(
                                          children: [
                                            ListTile(
                                                ...
                                                trailing: feedProvider.ar.getUserId() ==
