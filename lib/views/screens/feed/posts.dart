        ...
        child: Column(
          ...
          children: [ 
            ListTile(
              ...
              title: Text(widget.feedData[widget.i].user!.fullname ?? "...",
                style: poppinsRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                  color: ColorResources.black
                ),
              ),
              subtitle: Text(timeago.format((widget.feedData[widget.i].createdAt)!.toLocal(), locale: getTranslated('LOCALE', context)),
                style: poppinsRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                  color: ColorResources.dimGrey
                ),
              ),
              trailing: widget.feedData[widget.i].user!.uid == SharedPrefs.getUserId()
              ? grantedDeletePost(context, widget.feedData[widget.i].uid!) 
              : PopupMenuButton(
                  itemBuilder: (BuildContext buildContext) { 
                    return [
                      PopupMenuItem(
                        child: Text(getTranslated('BLOCK_CONTENT', context),
                          style: poppinsRegular.copyWith(
                      ...
                      PopupMenuItem(
                        child: Text(getTranslated('BLOCK_USER', context),
                          style: poppinsRegular.copyWith(
                            color: ColorResources.error,
                            fontSize: Dimensions.fontSizeDefault
                          )
            ...
            if(widget.feedData[widget.i].forumType == 'image')
              PostImage(
                false,
                widget.feedData[widget.i].media ?? [], 
              ...
              children: [
                SizedBox(
                  ...
                  child: Row(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Text(widget.feedData[widget.i].forumLikes?.total.toString() ?? "...", 
                        style: poppinsRegular.copyWith(
                          color: ColorResources.black,
                          fontSize: Dimensions.fontSizeDefault
                        )
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            Icons.thumb_up,
                            size: 16.0,
                            color: widget.feedData[widget.i].forumLikes!.likes!.isNotEmpty 
                ...
                Text('${widget.feedData[widget.i].forumComments?.total.toString()} ${getTranslated("COMMENT", context)}',
                  style: poppinsRegular.copyWith(
                    fontSize: Dimensions.fontSizeDefault
                  ),
                )
