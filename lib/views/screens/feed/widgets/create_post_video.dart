                ...
                children: [
                  InkWell(
                    ...
                    : () async {
                      ...
                      MediaInfo? info = await VideoServices.compressVideo(fileX!);
                      setState(() {
                        mediaInfo = info;
                      });
                      File f = File(mediaInfo!.path!);
                      await Future.wait([
                        context.read<FeedProvider>().sendPostVideo(context, caption, f)
                      ]);
  ...
  Widget displaySingleVideo() {
    ...
    : Column(
      ...
      children: [
        ...
        Text("${getTranslated("FILE_SIZE", context)}: ${widget.videoSize.toString()} KB",
          style: poppinsRegular.copyWith(
            fontSize: Dimensions.fontSizeDefault
          ),
        ),
