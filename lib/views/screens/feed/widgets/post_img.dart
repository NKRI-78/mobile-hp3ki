...
class PostImage extends StatefulWidget {
  ...
  const PostImage(this.username, this.caption, this.isDetail, this.medias,
      {Key? key})
      : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      CachedNetworkImage(
                          ...
                          errorWidget:
                              (BuildContext context, String url, dynamic _) {
                            return Container(
