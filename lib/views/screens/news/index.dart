...
class NewsScreen extends StatefulWidget {
  ...
  const NewsScreen({this.fromHome, Key? key}) : super(key: key);
...
class NewsScreenState extends State<NewsScreen> {
  ...
  SliverAppBar buildAppBar(BuildContext context) {
    return CustomAppBar(title: 'Berita', fromHome: widget.fromHome)
                ...
                Expanded(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      errorWidget:
                          (BuildContext context, String value, dynamic _) {
                        return Container(
                          width: double.infinity,
                          height: 125.0,
                          decoration: const BoxDecoration(
