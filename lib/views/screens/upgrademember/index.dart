...
class UpgradeMemberIndexScreen extends StatefulWidget {
  const UpgradeMemberIndexScreen({super.key});

  @override
  _UpgradeMemberIndexScreenState createState() => _UpgradeMemberIndexScreenState();
}

class _UpgradeMemberIndexScreenState extends State<UpgradeMemberIndexScreen>{
  ...
  Widget getCart() {
    return Consumer<UpgradeMemberProvider>(
