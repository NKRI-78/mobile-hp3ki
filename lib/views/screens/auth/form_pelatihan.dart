...
class FormPelatihanScreen extends StatefulWidget {
  
  const FormPelatihanScreen({ Key? key}) : super(key: key);

  @override
  State<FormPelatihanScreen> createState() => _FormPelatihanScreenState();
}

class _FormPelatihanScreenState extends State<FormPelatihanScreen> {
