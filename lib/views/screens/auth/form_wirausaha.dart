...
class FormWirausahaScreen extends StatefulWidget {
  
  const FormWirausahaScreen({ Key? key}) : super(key: key);

  @override
  State<FormWirausahaScreen> createState() => _FormWirausahaScreenState();
}

class _FormWirausahaScreenState extends State<FormWirausahaScreen> {
  ...
  late TextEditingController jumlahKaryawanC;
  late FocusNode jumlahKaryawanFn;

  late TextEditingController penanggungJawabC;
  late FocusNode penanggungJawabFn;

  late TextEditingController noHPPenanggungC;
  late FocusNode noHPPenanggungFn;
  ...
  Future<void> submit() async {
    ...
    String jumlahKaryawan = jumlahKaryawanC.text.trim();
    String penanggungJawab = penanggungJawabC.text.trim();
    String noHPPenanggung = noHPPenanggungC.text.trim();
    ...
    if (formKey.currentState!.validate()) {
      SharedPrefs.writeEnterpreneursData(
        ...
        personResponsible: penanggungJawab,
        noPersonResponsible: noHPPenanggung
      ); 
  ...
  void getData() {
    ...
    jumlahKaryawanC = TextEditingController();
    jumlahKaryawanFn = FocusNode();
    
    penanggungJawabC = TextEditingController();
    penanggungJawabFn = FocusNode();
    
    noHPPenanggungC = TextEditingController();
    noHPPenanggungFn = FocusNode();
  }
  ...
  void dispose() {
    ...
    jumlahKaryawanC.dispose();
    jumlahKaryawanFn.dispose();
    
    penanggungJawabC.dispose();
    penanggungJawabFn.dispose();
    
    noHPPenanggungC.dispose();
    noHPPenanggungFn.dispose();
  ...
  Widget buildTextFields() {
    return Column(
      children: [
        ...
        const SizedBox(height: 15.0,),
        CustomTextFieldV2(
          emptyWarning: "Isi Jumlah Karyawan",
          controller: jumlahKaryawanC,
          hintText: 'Jumlah Karyawan',
          maxLength: 10,
          isDecimalNumber: true,
          textInputType: TextInputType.number, 
          focusNode: jumlahKaryawanFn, 
          textInputAction: TextInputAction.next,
          isBorderRadius: true,
          isSuffixIcon: true,
          ...
          nextNode: penanggungJawabFn,
        ),
        const SizedBox(height: 15.0,),
        CustomTextFieldV2(
          emptyWarning: "Isi Penanggung Jawab",
          controller: penanggungJawabC,
          hintText: 'Penanggung Jawab',
          textInputType: TextInputType.text, 
          focusNode: penanggungJawabFn, 
          textInputAction: TextInputAction.next,
          nextNode: noHPPenanggungFn,
          isBorderRadius: true,
          isSuffixIcon: true,
        ),
        const SizedBox(height: 15.0,),
        CustomTextFieldV2(
          emptyWarning: "Isi No HP Penanggung Jawab",
          controller: noHPPenanggungC,
          hintText: 'No HP Penanggung Jawab',
          maxLength: 13,
          isPhoneNumber: true,
          textInputType: TextInputType.number, 
          focusNode: noHPPenanggungFn, 
          textInputAction: TextInputAction.done,
          isBorderRadius: true,
          isSuffixIcon: true,
        ),
