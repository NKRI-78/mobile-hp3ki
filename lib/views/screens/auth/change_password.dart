  ...
  Future<void> submit() async {
    ...
    if(formKey.currentState!.validate()){
      ...
      if(newPass.trim() != newPassConfirm.trim()) {
        ShowSnackbar.snackbar(getTranslated("NEW_PASSWORD_CONFIRM_DID_NOT_MATCH", context), "", ColorResources.error);
        return;
      }

      if(oldPass.trim() == newPass.trim()) {
        ShowSnackbar.snackbar(getTranslated("NEW_PASSWORD_DIFFERENT_OLD_PASSWORD", context), "", ColorResources.error);
        return;
      }
