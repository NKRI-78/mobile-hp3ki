...
class DetailInboxScreen extends StatefulWidget {
  ...
  const DetailInboxScreen({ Key? key}) : super(key: key);
    ...
    return Consumer<InboxProvider>(
      builder: (context, inboxProvider, child) {
        ...
        if(inboxProvider.inboxDetailStatus == InboxDetailStatus.empty) {
          return const Center(child: Text('Tidak ada detail inbox.'),);
        }
          ...
          child: Material(
            ...
            child: InkWell(
              onTap: () { 
                ...
                ShowSnackbar.snackbar(context, 'Nomor Virtual Account sudah tersalin', '', ColorResources.black);
              },
              borderRadius: BorderRadius.circular(10.0),
              child: Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i) {
                ...
                return ExpansionTile(
                  ...
                  children: data.steps!.asMap().map((int key, StepModel step) => MapEntry(key, 
                    Padding(
