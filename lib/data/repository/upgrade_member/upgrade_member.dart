...
class UpgradeMemberRepo {
  ...
  Future<InquiryModel?> sendPaymentInquiry({required String userId, required String paymentCode}) async {
    try {
      Response res = await dioClient!.post('${AppConstants.baseUrl}/api/v1/payment/inquiry', data: {
        "user_id" : userId,
