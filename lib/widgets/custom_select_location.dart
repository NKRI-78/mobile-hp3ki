...
class _CustomSelectLocationWidgetState
  ...
  var client = DioManager.shared.getClient();
  ...
  void fetchProvince() async {
    try {
      var res = await client
          .post("${AppConstants.baseUrl}/api/v1/administration/provinces");

      provinces = (res.data['data'] as List)
  ...
  void fetchCity(String name) async {
    try {
      var res = await client.post(
          "${AppConstants.baseUrl}/api/v1/administration/cities",
          data: {"province_name": name});
      cities = (res.data['data'] as List)
          .map((e) => AdministrationModel.fromMap(e))
          .toList();
      setState(() {});
    } catch (e) {
  ...
  void fetchDistrict(String name) async {
    try {
      var res = await client.post(
          ...
          data: {"city_name": name});
      districts = (res.data['data'] as List)
          .map((e) => AdministrationModel.fromMap(e))
          .toList();
      setState(() {});
    } catch (e) {
  ...
  void fetchSubDistrict(String name) async {
    try {
      ...
      subDistricts = (res.data['data'] as List)
          .map((e) => AdministrationModel.fromMap(e))
          .toList();
      setState(() {});
    } catch (e) {
  ...
  void fetchPostalCodes(String name) async {
    try {
      var res = await client.post(
          "${AppConstants.baseUrl}/api/v1/administration/postal-codes",
          data: {"subdistrict_name": name});

      postalCodes = (res.data['data'] as List)
          .map((e) => AdministrationModel.fromMap(e))
          .toList();
      setState(() {});
    } catch (e) {
  ...
  void fetchPostalCodesV2(String cityName, String districtName) async {
    try {
      var res = await client.post(
          "${AppConstants.baseUrl}/api/v1/administration/postal-codes/v2",
          data: {"district_name": districtName, "city_name": cityName});
      // print(res.data['data']);
      postalCodes = (res.data['data'] as List)
          .map((e) => AdministrationModel.fromMap(e))
          .toList();
