...
import 'package:hp3ki/repositories/google_map_api_repository/src/google_map_api_repository.dart';
import 'package:hp3ki/repositories/google_map_api_repository/src/models/place_autocomplete.dart';
import 'package:hp3ki/utils/location.dart';
...
class _CustomSelectMapLocationWidgetState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${getTranslated("TXT_CHOOSE", context)} ${getTranslated(
          "TXT_PIN_POINT",
          context,
        )}"),
      ),
