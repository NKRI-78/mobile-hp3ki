...
import 'package:hp3ki/data/models/feed/all.member.dart';
import 'package:hp3ki/data/models/feed/comment.dart';
import 'package:hp3ki/data/models/feed/groups.dart';
import 'package:hp3ki/data/models/feed/groupsmember.dart';
import 'package:hp3ki/data/models/feed/groupsmetadata.dart';
...
import 'package:hp3ki/data/models/feed/singlegroup.dart';
...
class FeedProvider with ChangeNotifier {
  ...
  Future<void> sendReply(BuildContext context, String text, String targetId, String postId) async {
    ...
    Future.delayed(Duration.zero, () {
      fetchListCommentMostRecent(context, postId);
      fetchAllReply(context, targetId);
    });
  }
